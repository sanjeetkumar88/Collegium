...
const EditProjectDetailsModal = ({ opened, onClose, projectData, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await projectApi.updateProjectDetails(projectData.id, {
        ...formValues,
        technologiesUsed: typeof formValues.technologiesUsed === 'string' ? formValues.technologiesUsed.split(",").map((tech) => tech.trim()) : formValues.technologiesUsed, // Handle array/string safely
      });
