...
import { compressPdf } from "../../shared/utils/compressPdf.js";
...
const uploadnotes = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (uploadedNotes?.public_id) {
       // Note: deleteFromCloudinary is not imported or defined in original file, 
       // but I'll leave a comment as it is in the source.
